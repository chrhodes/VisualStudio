...
using VNC_PT_APPLICATION.Domain.Lookups;

namespace VNC_PT_APPLICATION.Persistence.LookupData
{
    public class VNC_PT_APPLICATIONLookupsDbContext : DbContext
    {
        public DbSet<LookupType1> LookupType1Set { get; set; }

        public VNC_PT_APPLICATIONLookupsDbContext() : base("VNC_PT_ApplicationDB")
        {
            ...
            Database.SetInitializer<VNC_PT_APPLICATIONLookupsDbContext>(
                new DropCreateDatabaseIfModelChanges<VNC_PT_APPLICATIONLookupsDbContext>());
