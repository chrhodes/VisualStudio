...
namespace $safeprojectname$
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Database.SetInitializer(new NullDatabaseInitializer<$customAPPLICATION$DbContext>());

            using (var context = new $customAPPLICATION$DbContext())
            {
