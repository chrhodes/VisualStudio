...
{
    internal sealed class Configuration : DbMigrationsConfiguration<VNC_PT_APPLICATIONDbContext>
    {
        ...
        void SeedInitialDatabaseTables(VNC_PT_APPLICATIONDbContext context)
        {
